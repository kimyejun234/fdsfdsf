$(document).ready(function(){
	...
	$('.header').mouseenter(function(){
		...
		$(this).find('.logo a img').attr({'src':'img/logo.png'});
    });
    ...
    $('.header').mouseleave(function(){
		...
		$(this).find('.logo a img').attr({'src':'img/logo3.png'});
	...
	$(window).scroll(function(){ 
		...
		$(".pc_menu_btn").click(function(){
			...
			if(bb){
				...
				$('.header').removeClass('on');  
				$('.logo a img').attr({'src':'img/logo3.png'});
...
//	 });
	...
	$(window).scroll(function(){
		...
		if($(this).scrollTop()>=100 ){
			$('.btn_top').addClass('on'); 
			$('.btn_top img').attr({'src':'img//btn4.png'});
			
		}else{ 
			$('.btn_top').removeClass('on');
			$('.btn_top img').attr({'src':'img//btn1.png'});
		}
